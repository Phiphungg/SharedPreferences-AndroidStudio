package com.blogspot.atifsoftwares.sharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button mSaveBtn, mInfoBtn, mClearBtn;
    Switch mSwitch;
    TextView mInfoTv, outputName, outputAge;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputName = findViewById(R.id.nameEt);
        outputAge = findViewById(R.id.ageEt);
